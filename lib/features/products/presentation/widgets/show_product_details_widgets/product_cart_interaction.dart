...
import 'package:e_commerce_app/core/widgets/custom_quantity_button_widget.dart';
...
class _ProductCartInteractionState extends State<ProductCartInteraction> {
  ...
  void initState() {
    super.initState();
    isMaxQuantity = (widget.productQuantityInCart ?? 0) ==
        LocalConstants.limitProductNumberInCart;
                ...
                child: Expanded(
                  child: CustomTriggerButton(
                    ...
                    child: isAddToCartLoading
                        ...
                        : Column(
                            mainAxisAlignment: isMaxQuantity
